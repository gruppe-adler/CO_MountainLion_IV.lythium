...
_rock  = "#particlesource" createVehicleLocal (getpos vehicle player);
_rock attachto [vehicle player];
_rock setParticleRandom [0, [10, 10, 7], [4, 4, 5], 2, 0.1, [0, 0, 0, 0.5], 1, 1];
_rock setParticleCircle [100, [0, 0, 0]];
_rock setParticleParams [
["a3\data_f\cl_rock1.p3d", 1, 1, 1], "", "SpaceObject", 1, 27, [0,0,0], 
[_WindVectorX*10, _WindVectorY*10, 3], 2, 0.000001, 0.0, 0.1, [0.01 + random 0.01], [[0.68,0.68,0.68,1]], [1.5,1], 13, 13, "", "", vehicle player, 0, true ,1, [[0,0,0,0]]];
_rock setDropInterval 0.1;

[_leaves, _leaves, _rock]